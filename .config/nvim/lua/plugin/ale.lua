...
vim.cmd("autocmd Colorscheme * highlight ALEErrorSignLineNr guifg=#E06C75 guibg=#4D3840 gui=bold")
vim.cmd("autocmd Colorscheme * highlight ALEWarningSignLineNr guifg=#E5C07B guibg=#4E4942 gui=bold")
vim.cmd("autocmd Colorscheme * highlight ALEInfoSignLineNr guifg=#98C379 guibg=#3E4941 gui=bold")
-- blue #344559
-- magenta #483A55
-- cyan #334650
