...
local palette = {
  variable = { bg = util.darken(p.syntax.variable, 0.2, p.bg2), fg = p.syntax.variable },
  keyword = { bg = util.darken(p.syntax.keyword, 0.2, p.bg2), fg = p.syntax.keyword },
  file = { bg = util.darken(p.orange, 0.2, p.bg2), fg = p.orange },
  func = { bg = util.darken(p.syntax.func, 0.2, p.bg2), fg = p.syntax.func },
  constant = { bg = util.darken(p.syntax.constant, 0.2, p.bg2), fg = p.syntax.constant },
}
